...
RSpec.describe User, type: :model do
  ...
  describe "micropost associations" do
    ...
    describe "following" do
      ...
      it { expect(:followed_users).to should include(other_user) }
	...
	it { expect(:followed_users).to should_not include(other_user) }
      end

      it { should be_following(other_user) }
      #its(:followed_users) { should include(other_user) }
      #its(:followed_users) { should include(other_user) }
      it { expect(:followers).to should include(other_user) }

      describe "followed user" do
        subject { other_user }
        #its(:followers) { should include(@user) }
	it { expect(:followers).to should include(@user) }
      end
    end
